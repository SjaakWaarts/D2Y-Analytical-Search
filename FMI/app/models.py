...
class StudiesSeekerView (seeker.SeekerView, workbooks.StudiesWorkbook):
    ...
    facets = [
        ...
        seeker.PercFacet("perception.val.keyword", label = "Perception", nestedfield="perception", visible_pos=0),
        seeker.PercFacet("method.val.keyword", label = "Method", nestedfield="method", visible_pos=1),
        seeker.PercFacet("product_form.val.keyword", label = "Product Form", nestedfield="product_form", visible_pos=0),
        seeker.PercFacet("freshness.val.keyword", label = "Freshness", nestedfield="freshness", visible_pos=1),
        seeker.PercFacet("cleanliness.val.keyword", label = "Cleanliness", nestedfield="cleanliness", visible_pos=0),
        seeker.PercFacet("lastingness.val.keyword", label = "Lastingness", nestedfield="lastingness", visible_pos=0),
        seeker.PercFacet("intensity.val.keyword", label = "Intensity", nestedfield="intensity", visible_pos=0),
        seeker.PercFacet("liking.val.keyword", label = "Liking", nestedfield="liking", visible_pos=0),
        seeker.PercFacet("concept.val.keyword", label = "Concept", nestedfield="concept", visible_pos=0),
        seeker.PercFacet("emotion.val.keyword", label = "Emotion", nestedfield="emotion", visible_pos=1),
        seeker.PercFacet("fragrattr.val.keyword", label = "Fragr Attr", nestedfield="fragrattr", visible_pos=0),
        seeker.PercFacet("mood.val.keyword", label = "Mood", nestedfield="mood", visible_pos=0),
        seeker.PercFacet("smell.val.keyword", label = "Smell", nestedfield="smell", visible_pos=0),
        seeker.PercFacet("suitable_product.val.keyword", label = "Suitable Product", nestedfield="suitable_product", visible_pos=0),
        seeker.PercFacet("suitable_stage.val.keyword", label = "Suitable Stage", nestedfield="suitable_stage", visible_pos=1),
        seeker.PercFacet("hedonics.val.keyword", label = "Hedonics", nestedfield="hedonics", visible_pos=1),
        ]
    facets_keyword = [
        seeker.KeywordFacet("facet_keyword", label = "Benchmark", input="keywords_k"),
        ];
